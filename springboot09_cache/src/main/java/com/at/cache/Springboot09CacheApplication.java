 ...
 *          I、引入了redis的starter，cacheManager变为RedisCacheManager；
 *          II、默认创建的RedisCacheManager操作redis的时候使用的是RedisTemplate<Object, Object>；
 *          III、RedisTemplate<Object, Object>是默认使用jdk的序列化机制；
 *      4）、自定义CacheManager；
 */
